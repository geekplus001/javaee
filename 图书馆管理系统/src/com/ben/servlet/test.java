...
//		String path=getServletContext().getRealPath(""); 
		...
		System.out.println(new File("/测试/图书馆管理系统/WebContent/img").getAbsolutePath()); 
	}
...
//								request.setAttribute("message", "扩展名不符合规范！");
...
//							user_head_pic = saveFilename;
//							
//							// 得到文件的保存目录
//							String realSavePath = savePath;
//							// makePath(saveFilename, savePath);
//							// 创建一个文件输出流
...
//					request.getRequestDispatcher("/uploadHeadPic.jsp").forward(request, response);
//					return;
